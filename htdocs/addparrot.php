  ...
  <div class="type-container d-flex justify-content-around">
    ...
    <div class="dropdown">
      ...
      <?php
            ...
            echo '<li><a class="dropdown-item" style="cursor:pointer" id="linkprovider'.$countproviders.'" onclick="setProvider('.$countproviders.')">'.$row1->name.'</a></li>';
            $countproviders++;
             }
             echo '</ul>';
             echo '';
...
<input type="text" class="form-control" name="typename" id="typename" placeholder="Введите вид попугая"> <br>

<input type="text" class="form-control" name="providername" id="providername" placeholder="Введите поставщика"> <br>
