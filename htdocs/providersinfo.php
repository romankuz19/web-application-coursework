...
<div class="container">
    <?php
      ...
      echo '<div class="about d-flex flex-column justify-content-center">
      <h3 class="text-center">Название компании : '.$row->name.'</h3>    
      <h3 class="text-center">Краткая информация : '.$row->info.'</h3> 
      <h3 class="text-center">История : '.$row->history.'  </h3> 
        </div>';
