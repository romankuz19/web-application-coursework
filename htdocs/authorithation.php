...
<form class="form1"action="/auth.php" method="post">
            ...
            echo '
            <h6>Логин</h6>
            <input type="text" class="form-control" name="login" id="login" placeholder="Введите логин" value="'.$_SESSION["name"].'"> <br>
            
            <h6>Пароль</h6>
             <input type="password" class="form-control" name="pass" placeholder="Введите пароль"> <br>

            <div class="d-flex justify-content-between">
            <button class="btn btn-primary" type="submit">Авторизовать</button> <br>
            <a class="btn btn-primary" role="button" href="/reg.php">Создать аккаунт</a>
            </div>';
            ?>
