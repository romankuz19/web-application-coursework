...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
 ...
 $query1->execute([$id]);
  ...
  ?>
   ...
   <div class="mb-3">
     ...
     <input type="text" class="form-control" name="username" id="exampleInputEmail1" aria-describedby="emailHelp" value="'.$row4->name.'" readonly>
 ...
 ?>
   ...
   <div class="mb-3">
     <label for="exampleInputEmail2" class="form-label">Ваш логин</label>
     <input type="text" class="form-control" name="loginname" id="exampleInputEmail2" aria-describedby="emailHelp" value="'.$_SESSION['name'].'" readonly>
