...
<input type="text" class="form-control" name="parrottype" id="typename" placeholder="Введите вид попугая, информацию о котором нужно изменить"> <br>

<input type="text" class="form-control" name="descr" placeholder="Введите новый текст про тип попугая"> <br>
