...
<div class="container provcont" >
 ...
 while($row1 = $query1->fetch(PDO::FETCH_OBJ)) {
  ...
  echo '<a class="btn btn-outline-primary text-decoration-none" id="linktype'.$count.'" onclick="setActive('.$count.')" href="/parrots.php?id='.$row1->id.'" role="button">'.$row1->name.'</a>';
  $count++;
}
