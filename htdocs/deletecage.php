...
<input type="text" class="form-control" name="cagename" id="cagename" placeholder="Введите имя клетки, которую нужно убрать"> <br>


<div class="d-flex justify-content-center">
<button class="btn btn-danger" type="submit" name="upload">Убрать клетку</button> <br>
</div>
  ...
  <script>
    function setName(id){
      ...
      var settype=document.getElementById("cagename");
