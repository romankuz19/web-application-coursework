    ...
    //   echo '<ul>';
      ...
      echo '<div class="card-body">
        ...
        if(($row->amount)>0){
          ...
          $order="/orders1.php";
          echo '<a href="'.$order.'?id='.$row->id.'" class="card-link text-decoration-none m-0 disabled">Забронировать</a>';
        }
        else{
          // $text="Нет в наличии";
          $order="/notavailablecage.php";
          echo '<a href="'.$order.'?id='.$row->typeid.'" class="card-link text-decoration-none m-0 disabled">Забронировать</a>';
        }
