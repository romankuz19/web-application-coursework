  ...
  <div class="container">
    ...
    <?php
      ...
      echo ' <form class="form1 invisible" action="/closeorder.php" method="post" >
       ...
       <input type="number" class="form-control d-none" name="parrotid" id="parrotid" value="'.$parrotid.'"> 
  
      <input type="number" class="form-control d-none" name="userid" id="userid" value="'.$userid.'"> 
      
      <input type="text" class="form-control visible" name="isaccepted" id="isaccepted" >


  
      <input type="number" class="form-control d-none" name="cageid" id="cageid" value="'.$cageid.'">
      <h6 class="visible text-center">Заказ получен?</h6> 
      <div class="d-flex justify-content-center" style="padding-bottom:10px">
      
      <a class="btn btn-primary visible" id="yes" onclick="setYes()">Да</a> 
      <a class="btn btn-secondary visible" id="no" onclick="setNo()" >Нет</a> 
    ...
    function setYes(){
      ...
      var settype=document.getElementById("isaccepted");
