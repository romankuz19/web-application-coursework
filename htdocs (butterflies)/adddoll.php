  ...
  <div class="type-container d-flex justify-content-around">
    ...
    <br>
      ...
      <?php
          ...
          if($row4->admin == 1):
        ?>
            <form class="form1" style="width:500px" action="/add1.php" method="post" enctype="multipart/form-data">


<input type="text" class="form-control" name="typename" id="typename" placeholder="Введите вид куколки"> <br>

<input type="number" class="form-control" name="dollprice" placeholder="Введите цену куколки"> <br>

<input type="number" class="form-control" name="dollamount" placeholder="Введите количество куколок"> <br>

<input type="text" class="form-control" name="shortdiscr" placeholder="Введите краткую характеристику про куколку"> <br>

<input type="number" class="form-control" name="timetoborn" placeholder="Введите сколько времени до повления бабочки"> <br>
...
<button class="btn btn-warning" type="submit" name="upload">Добавить куколку</button> <br>
</div>
