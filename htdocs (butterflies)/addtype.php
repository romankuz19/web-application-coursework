...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  ...
  <div class="type-container d-flex justify-content-around">
      ...
      <?php
          ...
          if($row4->admin == 1):
        ?>
            <form class=" form1 w-50" action="/add2.php" method="post" enctype="multipart/form-data">

        
            


<input type="text" class="form-control" name="originalname" id="originalname" placeholder="Введите оригинальное название вида"> <br>

<input type="text" class="form-control" name="translatedname" placeholder="Введите переведенное называния вида"> <br>


<div class="d-flex justify-content-center">
<button class="btn btn-warning" type="submit" name="upload">Добавить вид</button> <br>
</div>
