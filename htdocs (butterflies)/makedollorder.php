...
<?php
          ...
          if($id):
            ...
            $query1 = $pdo->query("SELECT * FROM `chrysalis` WHERE `id` = $id");
...
<form class="form1" action="/sendorderdoll.php" method="post">
  ...
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-2 col-form-label" >Вид куколки</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" name="typename" id="inputPassword3" placeholder="Вид куколки" value="'.$row1->typename.'" readonly>
    </div>
  </div>
  <div class="form-group row">
