...
<div class="card  mb-3 w-100 h-100" style="max-width: 540px;">
  <div class="row g-0">
    <div class="col-md-4">
      ...
      <img src="data:image;base64,'.$row->img.'" class="rounded-start imgdoll" alt="...">
     </div>
   <div class="col-md-8">
      <div class="card-body w-100 h-100 ">
        ...
        <p class="card-text new">Превратится примерно через : '.$row->timetoborn.' дней</p>
